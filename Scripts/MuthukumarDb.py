    ...
    def wrapped(class_obj, *args, **kwargs):
        ...
        if class_obj.object_db.cursor_obj is None:
            ...
            try:
                ...
                class_obj.sql_con_obj = pyodbc.connect(
                    'DRIVER={SQL Server};SERVER=DESKTOP-NQDJHVJ\\SQLEXPRESS;\
                    DATABASE=user_verification;UID=sa;PWD=P@ssword;')
...
class MuthukumarDb(object):
    ...
    def Create_new_table(self, create_table_name, login_type, *args, **kwargs):
        ...
        if (self.cursor_obj.tables(table=create_table_name, tableType='TABLE').fetchone()):
            ...
            return False
        if login_type == 'USER':
            create_table_string = "CREATE TABLE user_verification.dbo." + create_table_name + "(user_firstname" \
            ...
            create_table_string = "CREATE TABLE admin_verification.dbo." + create_table_name + "(admin_adminname" \
        ...
        try:
            success_ret = self.cursor_obj.execute(create_table_string)
    ...
    def Insert_query(self, *args, **kwargs):
        ...
        try:
            success_ret = self.object_db.cursor_obj.execute(string)
    ...
    def Muthu_db(self, *args, **kwargs):
        """
        ..codeauthor:: Muthukumar Subramanian
        Muthu_db is main function of the file, this function will redirect to either signup or signin for admin/user
